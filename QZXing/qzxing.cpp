...
QString QZXing::decodeImageQML(QString imgPath)
{
    return decodeSubImageQML(imgPath);
}
...
QString QZXing::decodeSubImageQML(QString imgPath)
{
    if(imgPath  == NULL)
    {
        emit decodingFinished(false);
    ...
    //img.load("/home/nunofaria/Downloads/qrfree.kaywa.com.png");
    img.load(imgPath);
